...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    // (Length * 50ms typing speed) + 3000ms pause to read
  ...
  return (
    <div className="w-full h-screen lg:grid lg:grid-cols-2 overflow-hidden bg-background">
      ...
      <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-background relative">
        ...
        {/* Back Button */}
        <Link href="/" className="absolute top-8 left-8 text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="mx-auto grid w-[350px] gap-6">
          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-3 gap-3">
               ...
               <Button variant="outline" className="w-full" aria-label="Login with Facebook">
                  <FacebookIcon className="h-5 w-5 text-[#1877F2]" />
               </Button>
               <Button variant="outline" className="w-full" aria-label="Login with Microsoft">
